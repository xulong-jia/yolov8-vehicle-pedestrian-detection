...
- [ ] YOLOv8m experiment / YOLOv8m 实验 — Priority: P3 — Status: Optional — Output: `docs/experiments/yolov8m_*/` — Plan: Done — Plan output: `docs/yolov8m_experiment_plan.md` — Plan commit: `7ee5019` — Training/evaluation status: Not executed — Commit: TBD
